...
//        }
        Utilities.INSTANCE.setNavigationBarColor(getWindow(), overlayDrawNavBarColor);
        Utilities.INSTANCE.setLightNavigationBar(getWindow(), Utilities.INSTANCE.computePerceivedBrightness(overlayDrawNavBarColor) > .721);
    }
