...
//                var dt: Long = newTime - lastFrameTime
//                if (dt > 40 && first) {
//                    dt = 0
//                } else if (dt > 18) {
//                    dt = 18
...
//                val duration = if (open) 190.0f else 150.0f
...
//                if (open) {
//                    val clampedInterpolated = MathUtils.clamp(interpolated, 0f, 1f)
//                    containerView.alpha = clampedInterpolated
//                    containerView.translationX = AndroidUtilities.dp(48) * (1.0f - interpolated)
//                } else {
//                    val clampedReverseInterpolated = MathUtils.clamp(1f - interpolated, 0f, 1f)
//                    containerViewBack.alpha = clampedReverseInterpolated
//                    containerViewBack.translationX = AndroidUtilities.dp(48) * interpolated
//                }
...
//        fragment: Fragment,
//        fullScreen: Boolean = false
//    ): Array<FragmentContainer2?>? {
//        val actionBarLayout = arrayOf<FragmentContainer2?>(FragmentContainer2(context))
...
//    }
//
//    fun showAsSheet(fragment: Fragment, fullScreen: Boolean = false): Array<FragmentContainer2?>? {
//        val actionBarLayout = arrayOf<FragmentContainer2?>(FragmentContainer2(context))
//        val bottomSheet: BottomSheet = object : BottomSheet(parentActivity, true) {
//            init {
//                isFullscreen = fullScreen
...
//            return
//        }
//        bringToFront(fragmentStack.size - 1)
//    }
//
...
//        }
//        for (a in 0 until i) {
//            val previousFragment = fragmentStack[a]
...
//            }
//        }
//        val previousFragment = fragmentStack[i]
