...
import static com.ailnor.core.UtilsKt.RIPPLE_MASK_CIRCLE_20DP;
...
//        }
    ...
    public abstract static class Layout extends FrameLayout {
        ...
        public Layout(@NonNull Context context) {
            super(context);
            setMinimumHeight(UtilsKt.dp(48));
            setBackground(Theme.white);
            updateSize();
            setPadding(UtilsKt.dp(8), UtilsKt.dp(8), UtilsKt.dp(8), UtilsKt.dp(8));
            setWillNotDraw(false);
        }

        protected void setBackground(int color) {
            background = UtilsKt.createRoundRectDrawable(UtilsKt.dp(6), color);
        }
        ...
        private void updateSize() {
            ...
            setLayoutParams(UtilsKt.frameLayoutParams(isWideScreen ? wideScreenWidth : MATCH_PARENT, WRAP_CONTENT, isWideScreen ? Gravity.BOTTOM | wideScreenGravity : Gravity.BOTTOM));
        }
...
//            return AndroidUtilities.INSTANCE.isTablet() || AndroidUtilities.INSTANCE.getDisplaySize().x >= AndroidUtilities.INSTANCE.getDisplaySize().y;
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            background.setBounds(UtilsKt.dp(8), UtilsKt.dp(8), getMeasuredWidth() - UtilsKt.dp(8), getMeasuredHeight() - UtilsKt.dp(8));
    ...
    public static class ButtonLayout extends Layout {
        ...
        protected void measureChildWithMargins(View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
            if (button != null && child != button) {
                widthUsed += button.getMeasuredWidth() - UtilsKt.dp(12);
            }
        ...
        public void setButton(Button button) {
            ...
            if (button != null) {
                addCallback(button);
                addView(button, 0, frameLayoutParams(WRAP_CONTENT, WRAP_CONTENT, Gravity.END | Gravity.CENTER_VERTICAL));
            }
        }
    }
    ...
    public static class SimpleLayout extends ButtonLayout {
        ...
        public SimpleLayout(@NonNull Context context) {
            ...
            final int undoInfoColor = Theme.INSTANCE.getColorPrimary();

            imageView = new ImageView(context);
            imageView.setColorFilter(new PorterDuffColorFilter(undoInfoColor, PorterDuff.Mode.MULTIPLY));
            addView(imageView, frameLayoutParams(dp(24), dp(24), Gravity.START | Gravity.CENTER_VERTICAL, dp(16), dp(12), dp(16), dp(12)));
            ...
            addView(textView, frameLayoutParams(WRAP_CONTENT, WRAP_CONTENT, Gravity.START | Gravity.CENTER_VERTICAL, dp(56), 0, dp(16), 0));
        }
    ...
    public static class MultiLineLayout extends ButtonLayout {
        ...
        public MultiLineLayout(@NonNull Context context) {
            super(context);
            addView(imageView, frameLayoutParams(dp(30), dp(30), Gravity.START | Gravity.CENTER_VERTICAL, 12, 8, 12, 8));

            textView.setGravity(Gravity.START);
            textView.setPadding(0, UtilsKt.dp(8), 0, UtilsKt.dp(8));
            textView.setTextColor(Theme.INSTANCE.getColorPrimary());
            textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 15);
            textView.setTypeface(Typeface.SANS_SERIF);
            addView(textView, frameLayoutParams(MATCH_PARENT, WRAP_CONTENT, Gravity.START | Gravity.CENTER_VERTICAL, 56, 0, 16, 0));
        }
    ...
    public static class TwoLineLayout extends ButtonLayout {
        ...
        public TwoLineLayout(@NonNull Context context) {
            ...
            addView(imageView = new ImageView(context), frameLayoutParams(dp(29), dp(29), Gravity.START | Gravity.CENTER_VERTICAL, 12, 12, 12, 12));

            final LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(LinearLayout.VERTICAL);
            addView(linearLayout, frameLayoutParams(WRAP_CONTENT, WRAP_CONTENT, Gravity.START | Gravity.CENTER_VERTICAL, 54, 8, 12, 8));
            ...
            subtitleTextView.setLinkTextColor(Theme.red);
    ...
    public static class TwoLineLottieLayout extends ButtonLayout {
        ...
        public TwoLineLottieLayout(@NonNull Context context) {
            super(context);
            this.textColor = Theme.INSTANCE.getColorPrimary();
            setBackground(Theme.white);
            ...
            final int undoInfoColor = Theme.INSTANCE.getColorPrimary();
            final int undoLinkColor = Theme.red;

            final LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(LinearLayout.VERTICAL);
            addView(linearLayout, frameLayoutParams(WRAP_CONTENT, WRAP_CONTENT, Gravity.START | Gravity.CENTER_VERTICAL, 56, 8, 12, 8));
...
//            textView.setSingleLine();
            ...
            textView.setPadding(0, UtilsKt.dp(8), 0, UtilsKt.dp(8));
            addView(textView, frameLayoutParams(WRAP_CONTENT, WRAP_CONTENT, Gravity.START | Gravity.CENTER_VERTICAL, 56, 0, 8, 0));

            textView.setLinkTextColor(Theme.red);
            setTextColor(Theme.white);
            setBackground(Theme.INSTANCE.getColorPrimary());
        }
        ...
        public void setAnimation(int resId, String... layers) {
            setAnimation(resId, dp(32), dp(32), layers);
        }
...
//            }
        ...
        public void setIconPaddingBottom(int paddingBottom) {
            imageView.setLayoutParams(frameLayoutParams(dp(56), dp(48 - paddingBottom), Gravity.START | Gravity.CENTER_VERTICAL, 0, 0, 0, paddingBottom));
        }
...
//                undoTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
                ...
                undoTextView.setPadding(dp(16), 0, dp(16), 0);
                addView(undoTextView, frameLayoutParams(WRAP_CONTENT, dp(48), Gravity.CENTER_VERTICAL, 8, 0, 0, 0));
            } else {
...
//                undoImageView.setImageResource(R.drawable.chats_undo);
                ...
                undoImageView.setBackground(UtilsKt.createSelectorDrawable((undoCancelColor & 0x00ffffff) | 0x19000000, RIPPLE_MASK_CIRCLE_20DP, -1));
                undoImageView.setPadding(0, dp(12), 0, dp(12));
                addView(undoImageView, frameLayoutParams(dp(56), dp(48), Gravity.CENTER_VERTICAL));
            }
        }
